<?php
session_start();
if (empty($_SESSION['nama_n']) && empty($_SESSION['pass_n'])) {header('location:login.php');} 
else {   
...
<html>
	...
	<body>
		<div class="sidebar">
			<ul>
				<li>
					<a href="nasabah.php?page=data-nasabah" style="text-align: center; padding: 30px 0 30px 0; font-size: 20px;">Nasabah, <?php echo $_SESSION['nama_n']; ?></a>
				</li>
