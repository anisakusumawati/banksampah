        ...
        <tr align="center">
            ...
            <td>
              <?php
                        ...
                        $data = "UPDATE nasabah SET saldo=$tot_saldo_total WHERE nin='".$row['nin']."'";
                        $saldoakhir = $conn->query($data);
            ...
            <td>
              <?php 
                    $berat = mysqli_query($conn, "SELECT SUM(berat) AS totalberat FROM setor WHERE nin='".$row['nin']."'");
                    $totalnya = mysqli_fetch_array($berat);
                    $totalberat = $totalnya['totalberat'];                    
                    $data = "UPDATE nasabah
                     SET sampah = $totalberat
                     WHERE nin='".$row['nin']."'";
                    $beratakhir = $conn->query($data);
              ?>               
